...
import {
  ...
  createSuperAdminProduct as createProduct,
  updateSuperAdminProduct as updateProduct,
  deleteSuperAdminProduct as deleteProduct,
...
function buildShades(hex) {
  ...
  return [
    ...
    { label: "700", color: rgbToHex(r * 0.7, g * 0.7, b * 0.7) },
    { label: "800", color: rgbToHex(r * 0.5, g * 0.5, b * 0.5) },
    { label: "900", color: rgbToHex(r * 0.3, g * 0.3, b * 0.3) },
  ];
}
  ...
  return (
    <div>
      <PageHeader
        ...
        onButtonClick={() => navigate("/superadmin/products/create")}
      />
      {loading ? (
            ...
            actions={(row) => (
              <>
                ...
                <button
                  ...
                  onClick={() =>
                    navigate("/superadmin/products/update", {
                      state: { item: row },
                    })
                  }
                >
...
// ── Default export (fixes: "does not contain a default export") ───
