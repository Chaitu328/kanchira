...
export default function SuperAdminProfile() {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      <div className="rounded-2xl p-6 mb-6 text-white text-center"
        style={{ background: `linear-gradient(135deg, ${MAROON}, #810202, #975607)` }}>
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
        <h3 className="text-sm font-bold uppercase tracking-wider" style={{ color: MAROON }}>Profile Details</h3>
        {[
          ...
          { label: 'Joined',  value: display.createdAt ? new Date(display.createdAt).toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' }) : '—' },
        ].map(({ label, value }) => (
